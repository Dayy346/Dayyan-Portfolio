...
- **Sharper resume-aligned blurbs** added/rewritten for About, Projects, Contributions, Skills, Extracurricular, LeetCode, Contact, Chatbot, Resume — each window now opens with a 1–3 sentence intro that names concrete tech, employers, and outcomes (Olixir New York / Omnicom, CollabLab Vue + Node + Fargate, RAG benchmarking, East Coast Powerlifting Championships, etc.) instead of generic copy.
