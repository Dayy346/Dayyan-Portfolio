...
| **Software Engineer — CollabLab 2024 - Present** | Experience timeline: "Junior AI Engineer — Omnicom Health" + "Part-time Engineering Manager — CollabLab" + EXPERIENCE_UPDATES (CollabLab Leadership, Junior AI Engineer) | ☐ Ensure CollabLab 2024-Present with bullets (security, EC2, etc.) is present |
